...
class SecureRunner(TransportRunner):
    ...
    def _validate_cwd(self, host, cwd):
        ...
        # Keep the requested path: the fixed helper rejects symlinks component by component.
        return cwd
    ...
    def execute(self, alias, argv, *, cwd=None, timeout_seconds=None, mode="write", allow_destructive=False):
        ...
        payload = json.dumps([cwd, list(host.allowed_roots)])
        wire = ["python3", "-I", "-c", EXEC_HELPER, payload, *command]
