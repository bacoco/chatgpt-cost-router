"""Typed project-scoped lifecycle tools registered on the SSH fleet gateway."""
...
def register(server, runner):
    ...
    @server.tool(annotations=annotations(True))
    def fleet_jobs(host: str, project_id: str) -> dict:
        return call(runner(), host, "process_list", {"project_id":project_id})
